...
--
-- Name: orders_1; Type: TABLE; Schema: public; Owner: test-admin-user
--
...
ALTER TABLE public.orders_1 OWNER TO "test-admin-user";

--
-- Name: orders_2; Type: TABLE; Schema: public; Owner: test-admin-user
--
...
ALTER TABLE public.orders_2 OWNER TO "test-admin-user";
...
--
-- Name: orders_1 id; Type: DEFAULT; Schema: public; Owner: test-admin-user
--
...
--
-- Name: orders_1 price; Type: DEFAULT; Schema: public; Owner: test-admin-user
--
...
--
-- Name: orders_2 id; Type: DEFAULT; Schema: public; Owner: test-admin-user
--
...
--
-- Name: orders_2 price; Type: DEFAULT; Schema: public; Owner: test-admin-user
--
...
--
-- Data for Name: orders_1; Type: TABLE DATA; Schema: public; Owner: test-admin-user
--
...
--
-- Data for Name: orders_2; Type: TABLE DATA; Schema: public; Owner: test-admin-user
--
...
--
-- Name: orders orders_pkey1; Type: CONSTRAINT; Schema: public; Owner: test-admin-user
--
...
--
-- Name: orders orders_insert_499_or_less; Type: RULE; Schema: public; Owner: test-admin-user
--
...
--
-- Name: orders orders_insert_over_499; Type: RULE; Schema: public; Owner: test-admin-user
--
